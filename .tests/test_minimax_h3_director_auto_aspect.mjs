...
// Auto aspect must follow timeline slot order, not insertion order, in both frontends.
const slotSort = /sort\(\(a, b\) => \(Number\(a\.slot\) \|\| 0\) - \(Number\(b\.slot\) \|\| 0\) \|\| a\.order - b\.order\)\[0\]/;
for (const file of ["../js/minimax_h3_director_v2.js", "../js/minimax_h3_director.js"]) {
