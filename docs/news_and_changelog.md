...
This changelog covers the last two months: **2026-06-29 → 2026-08-29**. The first commit in this window is from 2026-07-05; older history lives in the git log.
...
Quick reference for the version bumps inside this window:
